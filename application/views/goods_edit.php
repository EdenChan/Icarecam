                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form class="form-horizontal" action="<?php echo site_url('admin/goods/update'); ?>"
                                  method="post" name="theForm" enctype="multipart/form-data">
                                <div class="control-group">
                                    <label class="control-label">商品名称：</label>

                                    <div class="controls">
                                        <input type="hidden" name="goods_id" size="30"
                                               value="<?php echo $goods['goods_id']; ?>">
                                        <input type="text" name="goods_name" size="30"
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="goods_brief" id="goods_brief"
                                                  style="height:100px;"><?php echo $goods['goods_brief'] ?></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="shop_price" id="shop_price"
                                               value="<?php echo $goods['shop_price']; ?>"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="market_price"
                                               value="<?php echo $goods['market_price']; ?>"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <img
                                            src="<?php echo base_url('public/uploads/') . '/' . $goods['goods_img']; ?>"
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea id="goods_params" name="goods_params"
                                                  style="height:100px;"><?php echo $goods['goods_params']; ?></textarea>

                                        <p class="help-block">
                                            设置商品参数时请遵循格式"参数1：参数值1，参数2：参数值2.."请去掉这里的双引号，并且格式中的：和，均为中文字符</p>
                                        <table>
                                            <?php
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea id="goods_desc"
                                                  name="goods_desc"><?php echo $goods['goods_desc']; ?></textarea>
                                    </div>
                                </div>
                            ...
                            <div id="myAlertBan1" class="modal hide">
                                ...
                                <form name="theForm2" class="form-horizontal"
                                      action="<?php echo site_url('admin/goods/update_img'); ?>" method="post"
