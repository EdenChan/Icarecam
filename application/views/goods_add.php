                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form class="form-horizontal" action="<?php echo site_url('admin/goods/insert'); ?>"
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="is_index" name="is_index" value="0"/><br/><span
                                            class="help-block">（此项填0可设置此商品不在首页展示，此项填1可设置此商品在首页展示，注意首页仅可出现2个展示商品）</span>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea id="goods_params" name="goods_params" style="height:100px;"
                                                  placeholder="参数1：参数值1，参数2：参数值2，参数3：参数值3"></textarea>

                                        <p class="help-block">
                                            设置商品参数时请遵循格式"参数1：参数值1，参数2：参数值2.."请去掉这里的双引号，并且格式中的：和，均为中文字符，最后一个参数不需加上逗号</p>
                                    </div>
                                </div>
                                <div class="control-group">
