					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form class="form-horizontal" action="<?php echo site_url('admin/apps/update');?>" method="post" name="theForm" enctype="multipart/form-data">
                                    <div class="control-group">
                                        <label class="control-label">软件名称：</label>
                                        <div class="controls">
                                            <input type="hidden" name="apps_id" size="30" value="<?php echo $apps['apps_id'];?>">
                                            <input type="text" name="apps_name" size="30" value="<?php echo $apps['apps_name'];?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <textarea id="apps_desc" name="apps_desc"><?php echo $apps['apps_desc'];?></textarea>
                                        </div>
                                    </div>
                                ...
                                <div id="myAlertBan1" class="modal hide">
                                    ...
                                    <form name="theForm2" class="form-horizontal" action="<?php echo site_url('admin/apps/update_img');?>" method="post" enctype="multipart/form-data">
                                    	<div class="control-group">
                                ...
                                <div id="myAlertBan2" class="modal hide">
                                    ...
                                    <form name="theForm3" class="form-horizontal" action="<?php echo site_url('admin/apps/update_file');?>" method="post" enctype="multipart/form-data">
                                        <div class="control-group">
