                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form class="form-horizontal" action="<?php echo site_url('admin/siteInfo/update'); ?>"
                                  method="post" name="theForm" enctype="multipart/form-data">
                                <div class="control-group">
                                    <label class="control-label">信息名称：</label>

                                    <div class="controls">
                                        <input type="hidden" name="siteInfo_id" size="30"
                                               value="<?php echo $siteInfo['siteInfo_id']; ?>"/>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea id="siteInfo_desc"
                                                  name="siteInfo_desc"><?php echo $siteInfo['siteInfo_desc']; ?></textarea>
                                    </div>
                                </div>
