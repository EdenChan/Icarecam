...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url('application/views/css/bootstrap-responsive.min.css');?>" type="text/css" />
    ...
    <body>
        ...
        <div id="loginbox">
            <form id="loginform" class="form-vertical" method="post" action="<?php echo site_url('admin/privilege/signin');?>" name='theForm' >
				<p>请输入用户名和密码</p>
