                                ...
                                <?php foreach ($order as $v): ?>
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            ...
                                            <a href="#myAlertBan<?php echo $v['order_id'] + 99999; ?>"
                                               data-toggle="modal"
                                                >更改状态</a>

                                            <div id="myAlertBan<?php echo $v['order_id'] + 99999; ?>"
                                                 class="modal hide">
                                                ...
                                                <form name="theForm3" class="form-horizontal"
                                                      action="<?php echo site_url('admin/order/update'); ?>"
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="hidden" name="order_sn"
                                                                   value="<?php echo $v['order_sn']; ?>" size="30"/>
                                                            <input type="text" id="order_status" name="order_status"
                                                                   size="20" value="<?php echo $v['order_status']; ?>"/>
                                        ...
                                        <td>
                                            <a class="btn btn-primary"
                                               href="<?php echo site_url('admin/order/detail') . '/' . $v['order_sn']; ?>">订单详情</a>
                                        </td>
                                        <td>
                                            ...
                                            <div id="myAlertBan<?php echo $v['order_id']; ?>" class="modal hide">
                                                ...
                                                <div class="modal-footer">
                                                    <a href="<?php echo site_url('admin/order/delete') . '/' . $v['order_sn']; ?>"
