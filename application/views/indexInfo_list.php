...
<?php require_once('sidebar.php'); ?>
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <form action="<?php echo site_url('admin/indexInfo/update'); ?>" method="post" name="theForm"
                ...
                <div class="span6">
                    <div class="widget-box">
                        ...
                        <div class="widget-content">
                            <textarea name="index_brief_desc" id="index_brief_desc" cols="50"
                                      rows="10"><?php echo $index_brief['indexInfo_desc']; ?></textarea>
                            <input type="hidden" name="index_brief_id"
                                   value="<?php echo $index_brief['indexInfo_id']; ?>"/>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="widget-content">
                                ...
                                <?php if (file_exists('public/uploads/index_slide_' . $i . '.jpg')) { ?>
                                    <div class="index_slide_<?php echo $i; ?>">
                                        当前图片：<br/><a href="<?php echo $index_slide_url_true['indexInfo_desc']; ?>"><img
                                                style="max-width: 150px;"
                                                src="<?php echo base_url('public/uploads/') . '/' . 'index_slide_' . $i . '.jpg'; ?>"></a>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="index_slide_<?php echo $i; ?>_url"
                                               id="<?php echo $index_slide_url_true['indexInfo_id']; ?>"
                                               value="<?php echo $index_slide_url_true['indexInfo_desc']; ?>"
                                               placeholder="http://"/>
                                        <span class="help-block">外链开头请加上http:// 否则无法保证正确链接</span>
                                        <input type="hidden" name="index_slide_<?php echo $i; ?>_url_id"
                                               value="<?php echo $index_slide_url_true['indexInfo_id']; ?>"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="index_slogan_desc" id="index_slogan_desc"
                                           value="<?php echo $index_slogan['indexInfo_desc']; ?>"/>
                                    <input type="hidden" name="index_slogan_id"
                                           value="<?php echo $index_slogan['indexInfo_id']; ?>"/>
                                </div>
                            </div>
                            <br/>
                            ...
                            <div class="index_slogan_bg">
                                当前图片：<br/><img style="max-width: 150px;"
                                               src="<?php echo base_url('public/uploads/') . '/' . 'index_slogan_bg.jpg'; ?>">
                            </div>
                        </div>
                    </div>
                </div>
