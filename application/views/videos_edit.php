                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form class="form-horizontal" action="<?php echo site_url('admin/videos/update'); ?>"
                                  method="post" name="theForm" enctype="multipart/form-data">
                                <div class="control-group">
                                    <label class="control-label">视频名称：</label>

                                    <div class="controls">
                                        <input type="hidden" name="videos_id" size="30"
                                               value="<?php echo $videos['videos_id']; ?>"/>
                                        <input type="text" name="videos_name" id="videos_name"
                                               value="<?php echo $videos['videos_name']; ?>"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="videos_brief" id="videos_brief"
                                                  style="height:100px;"><?php echo $videos['videos_brief'] ?></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <?php if ($videos['is_index'] == 1) { ?>
                                        ...
                                        <div class="controls">
                                            <input type="text" id="is_index" name="is_index" value="1"/><br/><span
                                                class="help-block">（此视频现在在首页展示，此项填0可从首页的展示位置中移除）</span>
                                        </div>
                                        <?php } else { ?>
                                        <label class="control-label">设置在首页出现：</label>
                                        <div class="controls">
                                            <input type="text" id="is_index" name="is_index" value="0"/><br/><span
                                                class="help-block">（此视频现在并未在首页展示区，此项填1可设置此视频在首页展示，注意首页仅可出现一个展示视频）</span>
                                        </div>
                                    <?php } ?>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <iframe height=300 width=300 src="<?php echo $videos['videos_src']; ?>"
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="videos_src"
                                               value="<?php echo $videos['videos_src']; ?>"/>

                                        <p class="help-block">请将想发布的优酷视频下方的“分享给好友”选项“通用代码”</p>

                                        <p class="help-block">（如：iframe height=498 width=510
                                            src="http://player.youku.com/1"）中的src链接，</p>

                                        <p class="help-block">如：http://player.youku.com/1
                                            复制粘贴到上面的输入框即可，请勿复制多余的代码，否则无法正常显示</p>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea id="videos_desc"
                                                  name="videos_desc"><?php echo $videos['videos_desc']; ?></textarea>
                                    </div>
                                </div>
