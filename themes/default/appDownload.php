                    ...
                    <?php foreach ($apps as $v): ?>
                        <div class="entry clearfix">
                            <div class="entry-image">
                                <a href="<?php echo base_url('public/uploads/') . '/' . $v['apps_img']; ?>"
                                   data-lightbox="image"><img class="image_fade"
                                                              src="<?php echo base_url('public/uploads/') . '/' . $v['apps_img']; ?>"
                                                              alt="Standard Post with Image"></a>
                            </div>
                            <div class="entry-c">
                                <div class="entry-title">
                                    <h2>
                                        <a href="<?php echo site_url('apps/single') . '/' . $v['apps_id']; ?>"><?php echo $v['apps_name']; ?></a>
                                    </h2>
                                </div>
                                <div class="entry-content">
                                    <p><?php echo $v['apps_brief']; ?></p>
                                    <a href="<?php echo site_url('apps/single') . '/' . $v['apps_id']; ?>"
