                    ...
                    <div class="single-post nobottommargin">
                        ...
                        <div class="entry clearfix">
                            ...
                            <div class="entry-image bottommargin">
                                <iframe width="600" height="400" src="<?php echo $videos['videos_src'];?>" frameborder=0 allowfullscreen></iframe>
                            </div><!-- .entry-image end -->
                        ...
                        ============================================= -->
                        <!-- 多说评论框 start -->
                        <div class="ds-thread" data-thread-key="<?php echo $videos['videos_id']+99999;?>" data-title="<?php echo $videos['videos_name'];?>" data-url="<?php echo site_url('videos/single').'/'. $videos['videos_id'];?>"></div>
                        <!-- 多说评论框 end -->
