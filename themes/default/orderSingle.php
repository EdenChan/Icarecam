		...
		<section id="page-title">
			...
			<div class="container clearfix">
				...
				<ol class="breadcrumb">
					...
					<li><a href="<?php echo site_url('user/showCenter');?>">用户中心</a></li>
					<li><a href="#">订单详情</a></li>
				</ol>
			</div>
            ...
            <div class="content-wrap">
                ...
                <div class="container clearfix">
                            ...
                            <?php foreach($order_goods as $v) :?>
                                <tr class="cart_item">
                                    <td class="cart-product-thumbnail">
                                        <img width="64" height="64" src="<?php echo base_url('public/uploads/').'/'.$v['goods_img'];?>" alt="产品图片">
                                    </td>

                                    <td class="cart-product-name">
                                        <a href="<?php echo site_url('goods/single').'/'. $v['id'];?>"><?php echo $v['goods_name'];?></a>
                                    </td>
                                    ...
                                    <td class="cart-product-quantity">
                                        <div class="quantity clearfix">
                                            <input type="text" name="quantity" value="<?php echo $v['goods_number'];?>" readonly="readonly" class="qty" />
                                        </div>
                                    </td>
                                    <td class="cart-product-quantity">
                    ...
                    <table class="table table-hover">
               		...
               		<ul class="pager">
                          <li class="previous"><a href="<?php echo site_url('user/showCenter');?>">← 返回</a></li>
                    </ul>
                </div>
            </div>
