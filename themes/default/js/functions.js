...
(function($){
   ...
   //          });
            ...
            // function setTotal() {
            //     var s = 0;
            //     $("#table_cart tr.cart_item").each(function() {
            //         s += parseInt($(this).find('input[class*=qty]').val()) * parseFloat($(this).find('span[class*=amount]').text());
            //     });
            //     $(".cart-total").html(s.toFixed(2));
            //     //设置表单中的订单总价
            //     $("#cart-total").val(s.toFixed(2));
            // }
            // setTotal();
		}
	};
