        ...
        <div class="swiper-wrapper">
            <?php for ($i = 1; $i < 5; $i++) {
                ...
                if (file_exists($file_name)) {
                    ...
                    ?>
                    <a href="<?php echo $index_slide_url_true['indexInfo_desc'];?>" class="swiper-slide dark"
                       style="background-image: url(<?php echo $file_name; ?>);"></a>
                <?php }
            } ?>
        </div>
...
<section id="content">
    ...
    <div class="content-wrap">
        ...
        <div class="section header-stick">
            <div class="container clearfix">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <a href="<?php echo site_url('siteInfo/show/companyInfo'); ?>"
                           class="button button-3d button-dark button-large btn-block center" style="margin-top: 30px;">了解更多</a>
                    </div>
        ...
        <div class="section parallax bottommargin-lg"
             style="background-image: url(<?php echo 'public/uploads/index_slogan_bg.jpg'; ?>); padding: 100px 0;"
        ...
        <div class="container clearfix">
            <?php foreach ($videos as $a): ?>
                ...
                <div class="col_two_fifth nobottommargin">
                    <a href="#">
                        <iframe height=300 width=350 src="<?php echo $a['videos_src']; ?>" frameborder=0
