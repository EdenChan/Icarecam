        ...
        <header id="header">
            ...
            <div id="header-wrap">
                ...
                <div class="container clearfix">
                    ...
                    ============================================= -->
                    <div id="logo">
                        <a href="<?php echo site_url();?>" class="standard-logo"><img src="<?php echo base_url('themes/default/images/logo.png');?>" alt="Logo"></a>
                    </div><!-- #logo end -->
                    ...
                    <nav id="primary-menu">
                        ...
                        <ul>
                            <li class="sub-menu"><a href="<?php echo site_url('goods/all');?>"><div>云摄像头</div></a></li>
                            <li class="sub-menu"><a href="<?php echo site_url('videos/all');?>"><div>视频演示</div></a></li>
                            <li><a href="#"><div>服务支持</div></a>
                                <ul>
                                    <li><a href="<?php echo site_url('apps/all');?>"><div>APP下载</div></a></li>
                                    <li><a href="<?php echo site_url('siteInfo/show/faqs');?>"><div>常见问题</div></a></li>
                                    <li><a href="<?php echo site_url('siteInfo/show/aftermarketPolicies');?>"><div>售后政策</div></a></li>
                                </ul>
                            <li class="sub-menu"><a href="<?php echo site_url('user/showCenter');?>"><div>会员中心</div></a></li>
                        </ul>

                        <!-- Top Cart
                        ============================================= -->
                        <div id="top-cart">
                            <a href="<?php echo site_url('cart/show');?>" onclick="window.location.href='<?php echo site_url('cart/show');?>'" id="top-cart-trigger"><i class="icon-shopping-cart"></i><span>购</span></a>
                        </div><!-- #top-cart end
