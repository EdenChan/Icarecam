                            ...
                            <td colspan="6">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-8 col-xs-8 nopadding">
                                        <a href="<?php echo site_url('goods/all'); ?>"
                                           class="button button-3d nomargin fright">继续购物</a>
                                        <a href="<?php echo site_url('order/show'); ?>"
                                           class="button button-3d notopmargin fright">前往结账</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
