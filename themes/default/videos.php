                    ...
                    <?php foreach ($videos as $v): ?>
                        <div class="entry clearfix">
                            <div class="entry-image">
                                <iframe width="300" height="200" src="<?php echo $v['videos_src']; ?>" frameborder=0
                                        allowfullscreen></iframe>
                            </div>
                            <div class="entry-c">
                                <div class="entry-title">
                                    <h2>
                                        <a href="<?php echo site_url('videos/single') . '/' . $v['videos_id']; ?>"><?php echo $v['videos_name']; ?></a>
                                    </h2>
                                </div>
                                <div class="entry-content">
                                    <p><?php echo $v['videos_brief']; ?></p>
                                    <a href="<?php echo site_url('videos/single') . '/' . $v['videos_id']; ?>"
