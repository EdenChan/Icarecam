                    ...
                    <div class="product">
                                ...
                                <div class="fslider" data-pagi="false" data-arrows="false" data-thumbs="true">
                                    <div class="flexslider">
                                        <div class="slider-wrap" data-lightbox="gallery">
                                            <div class="slide"><a
                                                    href="<?php echo base_url('public/uploads/') . '/' . $goods['goods_img']; ?>"
                        ...
                        <div class="col_two_fifth product-desc">
                            ...
                            <div class="product-price">
                                ...
                                <ins>￥<?php echo $goods['shop_price']; ?></ins>
                            </div>
                            ...
                            <form class="cart nobottommargin clearfix" method="post" enctype='multipart/form-data'
                                  action="<?php echo site_url('cart/add'); ?>">
                                <div class="quantity clearfix">
                                    <input type="button" value="-" class="minus">
                                    <input type="text" step="1" min="1" name="goods_quantity" value="1" title="Qty"
                                           class="qty" size="4"/>
                        ...
                        <div class="col_full nobottommargin">
                            ...
                            <div class="tabs clearfix nobottommargin" id="tab-1">
                                ...
                                <ul class="tab-nav clearfix">
                                    <li><a href="#tabs-1"><i class="icon-align-justify2"></i><span class="hidden-xs">详细介绍</span></a>
                                    </li>
                                    <li><a href="#tabs-2"><i class="icon-info-sign"></i><span
                                                class="hidden-xs">参数</span></a></li>
                                    <li><a href="#tabs-3"><i class="icon-star3"></i><span
                                                class="hidden-xs">评论</span></a></li>
                                </ul>
                                ...
                                <div class="tab-container">
                                    ...
                                    <div class="tab-content clearfix" id="tabs-3">
                                        ...
                                        <!-- 多说评论框 start -->
                                        <div class="ds-thread" data-thread-key="<?php echo $goods['goods_id'] + 999; ?>"
                                             data-title="<?php echo $goods['goods_name']; ?>"
                                             data-url="<?php echo site_url('goods/single') . '/' . $goods['goods_id']; ?>"></div>
                                        <!-- 多说评论框 end -->
